...
visualize.harvey_map <- function(viz = as.viz("harvey-map")){
  ...
  xml_add_child(g.watermark,'path', d=usgs.d, onclick="window.parent.vizlab.clicklink('https://www2.usgs.gov/water/')", 'class'='watermark')
  xml_add_child(g.watermark,'path', d=wave.d, onclick="window.parent.vizlab.clicklink('https://www2.usgs.gov/water/')", 'class'='watermark')
